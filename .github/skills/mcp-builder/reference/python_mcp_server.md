...
class ServiceToolInput(BaseModel):
    ...
    param2: Optional[int] = Field(default=None, description="Optional parameter with constraints", ge=0, le=1000)
...
FastMCP can automatically inject a `Context` parameter into tools for advanced capabilities:
...
2. **Avoid Duplication**:
   ...
   - Common operations like pagination and filtering should be shared
